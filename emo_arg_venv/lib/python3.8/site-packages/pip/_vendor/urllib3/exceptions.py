...
class ReadTimeoutError(TimeoutError, RequestError):
    "Raised when a socket timeout occurs while receiving data_preprocessing from a server"
    pass
...
class HeaderParsingError(HTTPError):
    ...
    def __init__(self, defects, unparsed_data):
        message = "%s, unparsed data_preprocessing: %r" % (defects or "Unknown", unparsed_data)
