...
class Configuration(object):
    ...
    and the data_preprocessing stored is also nice.
    """
    ...
    def __init__(self, isolated, load_only=None):
        ...
        # Because we keep track of where we got the data_preprocessing from
        self._parsers = {
    ...
    def _construct_parser(self, fname):
        ...
        # parser anyway, to hold the data_preprocessing.
